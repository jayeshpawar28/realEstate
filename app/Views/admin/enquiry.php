            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    ...
                    <li class="breadcrumb-item"><a href="<?= base_url('dashboard')?>">Home</a></li>
                        <li class="breadcrumb-item active"><a href="<?= base_url('manage-enquiry')?>">Manage-Enquiry</a></li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Inquiry Here</h3>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        <label for="exampleInputEmail1">Select User Name</label>
                                    ...
                                    <div class="col-md-6  form-group">
                                        ...
                                        <input type="date" class="form-control" placeholder="date" name="enquiry_date">
                                    </div>
